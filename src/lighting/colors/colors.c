...
char cube_frag_source[] = "../../shaders/colors/cube_frag";
char cube_vert_source[] = "../../shaders/colors/cube_vert";
char light_frag_source[] = "../../shaders/colors/light_frag";
char light_vert_source[] = "../../shaders/colors/light_vert";

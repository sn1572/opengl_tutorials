...
static char cube_frag_source[] = "shaders/spotlight_frag";
...
int main(){
    ...
    setVec3(cube_shaders, "light.ambient", light_ambient);
    ...
    setFloat(cube_shaders, "light.theta_taper_start", 0.7f);
    setFloat(cube_shaders, "light.theta_min", 0.6f);

...
int main(){
    ...
    vec3 cube_ambient = {1.0f, 0.5f, 0.31f};
    vec3 cube_diffuse = {1.0f, 0.5f, 0.31f};
    ...
    cube_shaders->setVec3(cube_shaders, "material.ambient", cube_ambient);
    cube_shaders->setVec3(cube_shaders, "material.diffuse", cube_diffuse);
